...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-30 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/15 transition-transform hover:scale-105 lg:bottom-5 lg:z-40"
    >
